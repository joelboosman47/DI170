...
console.log(jsonMarioGame); // everything gets printed in one line

// 2. Convert and pretty print this JS object into a JSON object. Hint : Check out the JSON lesson on the platform.
jsonMarioGame = JSON.stringify(marioGame, null, 3);
console.log(jsonMarioGame); // now it looks nice!

// 3. Use your web inspector to add a breakpoint. Check the values of the JSON object in the debugger.
// It still looks like a string. Of course every property name set between double quotes.
